...
## Reading the Data  
Reading the 2 csv files into the data frame.
...
2. Remove some columns of the dataset that do not contribute to our analysis.
```{r warning=FALSE, error=FALSE}
...
3. Remove columns that contain `NA's` values. 
```{r warning=FALSE, error=FALSE}
...
## Predict The Manner of Exercise for Test Data Set  
```{r warning=FALSE, error=FALSE}
rm(accuracy)
rm(os)
